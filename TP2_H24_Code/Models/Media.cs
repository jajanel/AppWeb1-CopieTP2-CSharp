...
namespace TP2_H24_Code.Models
{
    ...
    public class Media
    {
        ...
        /// </summary>
        public int Identifiant { get => identifiant; set { if (value < 0) { throw new FormatException("Format identifiant non valide"); } else { identifiant = value; } } }
        public string NomMedia { get => nomMedia; set { if (value == null) { throw new FormatException("Format nom non valide"); } else { nomMedia = value; } } }
        /// <summary>
        /// EvaluationCote ne doit pas être plus petit que 0 ou plus grand que 5. lance une erreur si c'est le cas
        /// </summary>
        public double EvaluationCote { get => evaluationCote; set { if (value < 0 || value > 5) { throw new ArgumentOutOfRangeException("Entrez une valeur entre 0 et 5"); } else { evaluationCote = 0; } } }
        /// <summary>
        ...
        public int DureeSecondes { get => dureeSecondes; set { if (value <= 0 || value > 3600) { throw new FormatException("Duree Invalide!"); } else { dureeSecondes = value; } } }
        //La valeur ne peut pas etre null. Si elle est vide, la string N/A sera mis à la place
        ...
        public string AudioExtrait { get => audioExtrait; set { if (value == null) { throw new FormatException("Lien extrait Invalide!"); } else { audioExtrait = value; } } }
        public string AudioComplet { get => audioComplet; set { if (value == null) { throw new FormatException("Lien audio Invalide!"); } else { audioComplet = value; } } }
        public string Image { get => image; set { if (value == null) { throw new FormatException("Lien image Invalide!"); } else { image = value; } } }
        public string Album { get => album; set { if (value == null) { throw new FormatException("Lien album Invalide!"); } else { album = value; } } }
        ...
        public string TempsMinutesSecondes()
        {
            TimeSpan temps = TimeSpan.FromSeconds(DureeSecondes);
            string tempsMinutesSecondes = temps.ToString(@"mm\:ss\ ");
            return tempsMinutesSecondes;
        }
