...
namespace WilliamN_MarcOlivierG_Tp1_H24_Code
{
    public class Utilisateur
    {
        ...
        public Utilisateur(int identifiant, string adresseCourriel, string motDePasse, string nom, string prenom, EnumRole role, HashSet<Media> favoris, HashSet<Evaluation> evaluations)
        {
        ...
        public int Identifiant { get => identifiant; set { if (value < 0) { throw new ArgumentOutOfRangeException("Identifiant Invalide!"); } else { identifiant = value; } } }
        ...
        public HashSet<Evaluation> Evaluations { get => evaluations; set => evaluations = value; }
        ...
        public void CreerEvalutation(int idMedia, int cote, string description)
        {
            ...
            evaluation.IdUtilisateur = this.identifiant;
        ...
        /// <summary>
        /// Redéfinition du equals sur l'Identifiant de l'utilisateur
        /// </summary>
        ...
        /// <summary>
        /// Redéfinition de la méthode sur l'Identifiant de l'utilisateur
        /// </summary>
