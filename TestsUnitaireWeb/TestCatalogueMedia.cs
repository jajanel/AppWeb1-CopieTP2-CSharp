...
namespace TestsUnitaireWeb
{
    public class TestCatalogueMedia
    {
        ...
        Media media1;
        Media media3;
        string pathJSONmedias = "../../../JSONTest/Media/CatalogueMedia/CatalogueMedia.json";
        ...
        public void Setup()
        {
            ...
            media3 = new Media(1, "One", 0, (EnumGenreDeMedia)1, new List<Evaluation>(), "1988-09-07", 446, "Metallica", "Flemming Rasmussen", "ext_One", "/musique/complet/full_One.mp3", "/images/album/img_And_Justice_For_All.jpg", "...And Justice for All");
        ...
        {
            catalogueMediaTest.Ajouter(pathJSONmedias);
